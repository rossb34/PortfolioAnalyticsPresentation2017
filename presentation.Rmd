...
* Feasible portfolio with bootstrap or Monte Carlo Simulation?
...
baseline portfolio specification and box constraint portfolio specification.

```{r, eval=FALSE}
sim.base <- simulate.portfolio(R, rp, simulations = 1000, 
                               rebalance_on = 'quarters')
sim.box <- simulate.portfolio(R, rp.box, simulations = 1000, 
                              rebalance_on = 'quarters')
...
## Simulated vs. Optimal Portfolios: Risk Return Scatter

![](figures/sim_scatter.png)

---

## Simulated vs. Optimal Portfolios: Distribution
